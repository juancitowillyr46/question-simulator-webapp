...
export class InitFunctionJsService {
  ...
  executeSideBar() {
    ...
    $("#menuCollasped").on("click", function () {
        ...
        if(pageWrapper.hasClass("menu-collasped-active")) {
            ...
            $(".ecaps-page-content").attr("style", '');
        } else {
            pageWrapper.addClass("menu-collasped-active");
            $(".ecaps-page-content").attr("style", 'margin-left: 65px; padding-top: 70px;');
            // pageWrapper.attr("style", 'margin-left:65px');
        }
    });
  ...
  executeFunction() {
    ...
    //console.log('Execution functions js...');
